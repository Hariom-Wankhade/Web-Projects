            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input id="" type="number" name="student_comp_ratio" class="form-control" placeholder="">
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-sm-4">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        ...
                        <input type="number" name="no_of_vacant_post_for_faculty" class="form-control" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
                <div class="col-sm-4">
                    ...
                    <label for="">No OF Vacant Post For HOD *</label>
                        <input type="number" name="No_of_vacant_post_for_hod" class="form-control" required>
                        <div class="help-block with-errors"></div>
                    </div>
                </div>
